# OpenAPI Endpoint Inventory (Baseline)

- Source: openapi.json
- Generated: 2026-04-14T09:18:54.102Z

| Method | Path | Tags | OperationId | Summary |
|---|---|---|---|---|
...
| POST | /api/bookings | Bookings, Akfeek Journey, 1. الورش المعتمدة (Certified Workshops), 2. ورش الغسيل (Car Wash), 3. العناية الشاملة (Comprehensive Care) |  | Create booking (الورش المعتمدة / العناية الشاملة) |
...
| GET | /api/bookings/{id} | Bookings, 1. الورش المعتمدة (Certified Workshops) |  | Get booking by ID (Admin or Customer — تفاصيل حجزي) |
| PATCH | /api/bookings/{id}/complete | Bookings, 1. الورش المعتمدة (Certified Workshops), 2. ورش الغسيل (Car Wash), 3. العناية الشاملة (Comprehensive Care) |  | Mark booking as completed (Vendor) |
| PATCH | /api/bookings/{id}/confirm | Bookings, 1. الورش المعتمدة (Certified Workshops), Akfeek Journey |  | Confirm booking (Vendor – Certified Workshop) |
| GET | /api/bookings/{id}/inspection-report | Bookings, 1. الورش المعتمدة (Certified Workshops) |  | Get inspection report for booking (customer / workshop vendor / admin) |
| PATCH | /api/bookings/{id}/mobile-workshop-status | Bookings, 5. الورش المتنقلة (Mobile Workshop) |  | Update mobile workshop booking status (Vendor) — في الطريق / وصل / جاري التنفيذ / تم |
| PATCH | /api/bookings/{id}/start | Bookings, 1. الورش المعتمدة (Certified Workshops) |  | Start booking (Vendor – Certified Workshop) — بدء تنفيذ الحجز |
...
| GET | /api/bookings/my | Bookings, 1. الورش المعتمدة (Certified Workshops) |  | My bookings (Customer) — حجوزاتي / حالة الحجز |
...
| POST | /api/bookings/towing/request | 4. Towing, Akfeek Journey |  | 1. إنشاء طلب سحب (ونش) — Create towing request |
...
| GET | /api/invoices/my/{id} | Invoices, 2. ورش الغسيل (Car Wash), 3. العناية الشاملة (Comprehensive Care) |  | Get my invoice (Customer) — جلب فاتورتي |
| PATCH | /api/invoices/my/{id}/pay | Invoices, Akfeek Journey, 2. ورش الغسيل (Car Wash), 3. العناية الشاملة (Comprehensive Care), 4. Towing |  | Pay my invoice (Customer) — دفع فاتورتي |
...
| GET | /api/services | Services, 2. ورش الغسيل (Car Wash), 3. العناية الشاملة (Comprehensive Care), 4. الورش المعتمدة (Certified Workshop), 5. الورش المتنقلة (Mobile Workshop) |  | Get all services |
...
| GET | /api/services/car-wash | Services, 2. ورش الغسيل (Car Wash) |  | Get all car wash services |
| GET | /api/services/car-wash/{vendorId} | Services, 2. ورش الغسيل (Car Wash) |  | Get car wash services for specific vendor |
| GET | /api/services/comprehensive-care | Services, 3. العناية الشاملة (Comprehensive Care) |  | Get all comprehensive care services |
| GET | /api/services/mobile-workshop | Services, 5. الورش المتنقلة (Mobile Workshop) |  | Get all mobile workshop services |
| GET | /api/services/workshop | Services, 4. الورش المعتمدة (Certified Workshop) |  | Get all certified workshop services |
...
| GET | /api/workshops | 1. الورش المعتمدة (Certified Workshops), Akfeek Journey |  | Get all certified workshops |
...
| GET | /api/workshops/{id}/services | 1. الورش المعتمدة (Certified Workshops), Bookings, Akfeek Journey |  | Get workshop services (list for booking) |
