...
class AutoPartService {
  ...
  async createPart(data, requestingUser) {
    ...
    const part = await prisma.autoPart.create({
      data: {
        ...
        createdByUser: { connect: { id: requestingUser.id } },
        category: { connect: { id: categoryId } },
        brand: brand || undefined,
        brandId: brandId ? brandId : undefined,
        vehicleModelId: vehicleModelId ? vehicleModelId : undefined,
  ...
  async updatePart(id, data, requestingUser) {
    ...
    const updateData = {
      ...
      ...(vehicleModelId !== undefined && { vehicleModelId: vehicleModelId || null }),
